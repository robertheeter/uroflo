"""
Django settings for uroflo_django project.
...
INSTALLED_APPS = [
    ...
    'user_interface.apps.UserInterfaceConfig' # add interface app
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000', # replace with React frontend URL
]
...
WSGI_APPLICATION = 'uroflo_django.wsgi.application'
