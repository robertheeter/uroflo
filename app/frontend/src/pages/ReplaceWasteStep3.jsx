...
const ReplaceWasteStep3 = () => {
  ...
  const done = () => {
    const url_added = "http://localhost:8000/interface/waste_replace_added";
    const data_added = {
      waste_replace_added: "TRUE",
    };
    axios
    ...
    const url_volume = "http://localhost:8000/interface/waste_replace_volume";
    const data_volume = {
