...
if __name__ == '__main__':
    ...
    if sensor_type in ['VIS', 'AS7262']:
        print('450 nm / violet : {:.4f}'.format(avg_trials[450]))
        print('500 nm / blue   : {:.4f}'.format(avg_trials[500]))
        print('550 nm / green  : {:.4f}'.format(avg_trials[550]))
        print('570 nm / yellow : {:.4f}'.format(avg_trials[570]))
        print('600 nm / orange : {:.4f}'.format(avg_trials[600]))
        print('650 nm / red    : {:.4f}'.format(avg_trials[650]))

    elif sensor_type in ['NIR', 'AS7263']:
        print('610 nm / orange : {:.4f}'.format(avg_trials[610]))
        print('680 nm / red    : {:.4f}'.format(avg_trials[680]))
        print('730 nm / IR     : {:.4f}'.format(avg_trials[730]))
        print('760 nm / IR     : {:.4f}'.format(avg_trials[760]))
        print('810 nm / IR     : {:.4f}'.format(avg_trials[810]))
        print('860 nm / IR     : {:.4f}'.format(avg_trials[860]))
